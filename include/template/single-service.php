...
<div class="cr-cta-area it-cta-inner-style z-index-1 fix p-relative pb-120">
    <img class="cr-cta-shape-1" src="<?php echo plugin_dir_url(__FILE__) . 'assets/dummy/shape/cta-4-1.png'; ?>" alt="">

    <img class="cr-cta-shape-2" src="<?php echo plugin_dir_url(__FILE__); ?>/assets/dummy/shape/cta-4-2.png" alt="">
    <img class="cr-cta-shape-3" src="<?php echo plugin_dir_url(__FILE__); ?>/assets/dummy/shape/cta-4-3.png" alt="">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
