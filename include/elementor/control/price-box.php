...
$this->add_group_control(
    ...
    [
        ...
        'selector' => '{{WRAPPER}} .it-price-head p',
    ]
);
...
$this->add_control(
    ...
    [
        ...
        'type' => Controls_Manager::COLOR,
        'selectors' => [
            '{{WRAPPER}} .dt-price-style .it-price-item.active .it-btn' => 'color: {{VALUE}}',
        ],
    ]
);
...
$this->add_control(
    ...
    [
        ...
        'type' => Controls_Manager::COLOR,
        'selectors' => [
            '{{WRAPPER}} .dt-price-style .it-price-item.active .it-btn' => 'background-color: {{VALUE}}',
        ],
    ]
);
...
$this->add_control(
    ...
    [
        ...
        'type' => Controls_Manager::COLOR,
        'selectors' => [
            '{{WRAPPER}} .it-btn.black-bg::after' => 'background-color: {{VALUE}}',
        ],
    ]
);
